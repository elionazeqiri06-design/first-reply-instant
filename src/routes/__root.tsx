...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Instant lead engagement for remodeling and contracting companies.",
      },
      { property: "og:title", content: "FirstReply" },
      {
    ...
    links: [
      ...
      { rel: "icon", href: "/firstreply-favicon.png", type: "image/png" },
    ],
  }),
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Analytics /> breaks all child routes. */}
      <Outlet />
      <Analytics />
    </QueryClientProvider>
  );
